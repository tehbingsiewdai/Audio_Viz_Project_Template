...
module VGA_DISPLAY(
    ...
    input [3:0] VGA_R_Text,
    input [3:0] VGA_G_Text,
    input [3:0] VGA_B_Text,
    ...
    wire[3:0] VGA_RED_CHAN = VGA_RED_GRID | VGA_RED_WAVEFORM | VGA_R_Text;
    wire[3:0] VGA_GREEN_CHAN = VGA_GREEN_GRID | VGA_GREEN_WAVEFORM | VGA_G_Text; 
    wire[3:0] VGA_BLUE_CHAN = VGA_BLUE_GRID | VGA_BLUE_WAVEFORM | VGA_B_Text;   
